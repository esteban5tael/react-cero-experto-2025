...
const initialHeroes: Hero[] = [
    ...
    },
    {
        ...
        description:
            "The Fastest Man Alive, protector of Central City.",
        strength: 7,
        team: "Justice League",
        image: "/placeholder.svg?height=200&width=200",
    },
            ...
            <div className="max-w-7xl mx-auto">
                ...
                <div className="text-center mb-8">
                    ...
                    <p className="text-gray-600">
                        Discover and manage your favorite superheroes
                    </p>
                </div>
                    ...
                    >
                        ...
                        <DialogContent className="max-w-md">
                            <DialogHeader>
                                ...
                                <DialogDescription>
                                    Create a new superhero profile
                                    with their details and abilities.
                                </DialogDescription>
                            </DialogHeader>
